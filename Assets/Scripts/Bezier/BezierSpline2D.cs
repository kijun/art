...
public class BezierSpline2D {
    ...
    public BezierSpline2D(params Vector2[] pts) {
        // assume 4
        Reset();
        SetControlPoint(0, pts[0]);
        SetControlPoint(1, pts[1]);
        SetControlPoint(2, pts[2]);
        SetControlPoint(3, pts[3]);
    }
    ...
    public void SetControlPoint (int index, Vector2 point) {
        SetControlPoint(index, (Vector3)point);
    }
    ...
    public void AddCurve(Vector2 p1, Vector2 p2, Vector2 p3) {
		Array.Resize(ref points, points.Length + 3);
