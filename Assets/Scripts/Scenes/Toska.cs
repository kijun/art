...
public class ToskaComposition {
    public List<ToskaSubComposition> subs = new List<ToskaSubComposition>();
}

public class ToskaSubComposition {
    public int layer;
    public Color color;
    public List<ToskaLine> lines = new List<ToskaLine>();
}

public class ToskaLine {
    public Coord start;
    public Coord end;
}

public class Toska : MonoBehaviour {

    public int width;
    public int height;

    public int MIN_LINE_NUM = 5;
